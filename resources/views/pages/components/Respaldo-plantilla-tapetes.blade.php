...
<rect id="_x31_1" x="316" y="20.1"  width="52" height="32" class="st0 {{in_array(11,$mats)? 'ocup': 'disp'}}"  data-place="11" data-btn="{{(Auth::check())? (in_array(11,$mats)? 'una' : 'mat'): (in_array(11,$mats)? 'una' : 'guest')}}"/>
<rect id="_x31_2" x="316" y="63.8"  width="52" height="32" class="st0 {{in_array(12,$mats)? 'ocup': 'disp'}}"  data-place="12" data-btn="{{(Auth::check())? (in_array(12,$mats)? 'una' : 'mat'): (in_array(12,$mats)? 'una' : 'guest')}}"/>
<rect id="_x31_3" x="316" y="108.1"  width="52" height="32" class="st0 {{in_array(13,$mats)? 'ocup': 'disp'}}" data-place="13"  data-btn="{{(Auth::check())? (in_array(13,$mats)? 'una' : 'mat'): (in_array(13,$mats)? 'una' : 'guest')}}"/>
<rect id="_x31_4" x="316" y="151.8"  width="52" height="32" class="st0 {{in_array(14,$mats)? 'ocup': 'disp'}}" data-place="14"  data-btn="{{(Auth::check())? (in_array(14,$mats)? 'una' : 'mat'): (in_array(14,$mats)? 'una' : 'guest')}}"/>
<rect id="_x31_5" x="316" y="196.1"  width="52" height="32" class="st0 {{in_array(15,$mats)? 'ocup': 'disp'}}" data-place="15"  data-btn="{{(Auth::check())? (in_array(15,$mats)? 'una' : 'mat'): (in_array(15,$mats)? 'una' : 'guest')}}"/>
<rect id="_x31_6" x="316" y="239.8"  width="52" height="32" class="st0 {{in_array(16,$mats)? 'ocup': 'disp'}}" data-place="16"  data-btn="{{(Auth::check())? (in_array(16,$mats)? 'una' : 'mat'): (in_array(16,$mats)? 'una' : 'guest')}}"/>
<rect id="_x31_7" x="316" y="284.1"  width="52" height="32" class="st0 {{in_array(17,$mats)? 'ocup': 'disp'}}" data-place="17"  data-btn="{{(Auth::check())? (in_array(17,$mats)? 'una' : 'mat'): (in_array(17,$mats)? 'una' : 'guest')}}"/>
<rect id="_x31_8" x="316" y="327.8"  width="52" height="32" class="st0 {{in_array(18,$mats)? 'ocup': 'disp'}}" data-place="18"  data-btn="{{(Auth::check())? (in_array(18,$mats)? 'una' : 'mat'): (in_array(18,$mats)? 'una' : 'guest')}}"/>
<rect id="_x31_9" x="316" y="372.1"  width="52" height="32" class="st0 {{in_array(19,$mats)? 'ocup': 'disp'}}" data-place="19"  data-btn="{{(Auth::check())? (in_array(19,$mats)? 'una' : 'mat'): (in_array(19,$mats)? 'una' : 'guest')}}"/>
<rect id="_x32_0" x="316" y="415.8"  width="52" height="32" class="st0 {{in_array(20,$mats)? 'ocup': 'disp'}}" data-place="20"  data-btn="{{(Auth::check())? (in_array(20,$mats)? 'una' : 'mat'): (in_array(20,$mats)? 'una' : 'guest')}}"/>
<rect id="_x31_0" x="14.8" y="20.1"  width="52" height="32" class="st0 {{in_array(10,$mats)? 'ocup': 'disp'}}" data-place="10"  data-btn="{{(Auth::check())? (in_array(10,$mats)? 'una' : 'mat'): (in_array(10,$mats)? 'una' : 'guest')}}"/>
<rect id="_x39_" x="14.8" y="63.8"  width="52" height="32" class="st0 {{in_array(9,$mats)? 'ocup': 'disp'}}"  data-place="9" data-btn="{{(Auth::check())? (in_array(9,$mats)? 'una' : 'mat'): (in_array(9,$mats)? 'una' : 'guest')}}"/>
<rect id="_x38_" x="14.8" y="108.1"  width="52" height="32" class="st0 {{in_array(8,$mats)? 'ocup': 'disp'}}" data-place="8"  data-btn="{{(Auth::check())? (in_array(8,$mats)? 'una' : 'mat'): (in_array(8,$mats)? 'una' : 'guest')}}"/>
<rect id="_x37_" x="14.8" y="151.8"  width="52" height="32" class="st0 {{in_array(7,$mats)? 'ocup': 'disp'}}" data-place="7"  data-btn="{{(Auth::check())? (in_array(7,$mats)? 'una' : 'mat'): (in_array(7,$mats)? 'una' : 'guest')}}"/>
<rect id="_x36_" x="14.8" y="196.1"  width="52" height="32" class="st0 {{in_array(6,$mats)? 'ocup': 'disp'}}" data-place="6"  data-btn="{{(Auth::check())? (in_array(6,$mats)? 'una' : 'mat'): (in_array(6,$mats)? 'una' : 'guest')}}"/>
<rect id="_x35_" x="14.8" y="239.8"  width="52" height="32" class="st0 {{in_array(5,$mats)? 'ocup': 'disp'}}" data-place="5"  data-btn="{{(Auth::check())? (in_array(5,$mats)? 'una' : 'mat'): (in_array(5,$mats)? 'una' : 'guest')}}"/>
<rect id="_x34_" x="14.8" y="284.1"  width="52" height="32" class="st0 {{in_array(4,$mats)? 'ocup': 'disp'}}" data-place="4"  data-btn="{{(Auth::check())? (in_array(4,$mats)? 'una' : 'mat'): (in_array(4,$mats)? 'una' : 'guest')}}"/>
<rect id="_x33_" x="14.8" y="327.8"  width="52" height="32" class="st0 {{in_array(3,$mats)? 'ocup': 'disp'}}" data-place="3"  data-btn="{{(Auth::check())? (in_array(3,$mats)? 'una' : 'mat'): (in_array(3,$mats)? 'una' : 'guest')}}"/>
<rect id="_x32_" x="14.8" y="372.1"  width="52" height="32" class="st0 {{in_array(2,$mats)? 'ocup': 'disp'}}" data-place="2"  data-btn="{{(Auth::check())? (in_array(2,$mats)? 'una' : 'mat'): (in_array(2,$mats)? 'una' : 'guest')}}"/>
<rect id="_x31_" x="14.8" y="415.8"  width="52" height="32" class="st0 {{in_array(1,$mats)? 'ocup': 'disp'}}" data-place="1"  data-btn="{{(Auth::check())? (in_array(1,$mats)? 'una' : 'mat'): (in_array(1,$mats)? 'una' : 'guest')}}"/>
