...
@endpush
    ...
    <div id="main">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m6 l6">
                            <h5 class="m-0 sidebar-title"><i class="fas fa-users"></i> Instructores (<span id="total-entries"></span>)</h5>
                        </div>
        ...
        <div class="row">
            <div class="col s12">
                <div class="container">
                    @if(Auth::user()->checkPermiso("cre_instructor"))
    ...
    <div id="modal-delete" class="modal">
        ...
        <div class="modal-footer">
            <form method="POST" action="{{route('admin.instructor.delete')}}">
                @method('DELETE')
                @csrf
    ...
    <div id="modal-change-status" class="modal">
        ...
        <div class="modal-footer">
            <form method="POST" action="{{route('admin.instructor.change.status')}}">
                @method('PUT')
                @csrf
                <input type="hidden" name="id" value="">
...
@push('js')
    ...
    <script src="{{asset('admin/js/custom/instructor.js')}}"></script>
