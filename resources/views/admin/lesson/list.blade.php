...
@endpush
    ...
    <div id="main">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m6 l6">
                            <h5 class="m-0 sidebar-title"><i class="fas fa-users"></i> Clases (<span id="total-entries"></span>)</h5>
                        </div>
        ...
        <div class="row">
            <div class="col s12">
                <div class="container">
                        @if(Auth::user()->checkPermiso("cre_clases"))
                    <div style="bottom: 54px; right: 19px;" class="fixed-action-btn direction-top">
                        <a class="btn-floating btn-large primary-text gradient-shadow modal-trigger" href="{{route('admin.lesson.create')}}">
                    ...
                    <div class="content-area content-right">
                        ...
                        @elseif(session()->has('message'))
                            <div class="card-alert card green">
                                <div class="card-content white-text">
                                    <p>
                                        <i class="material-icons">check_circle</i>  {{ session()->get('message') }}
                                    </p>
                                </div>
                            </div>
                        @endif
                            <div class="datatable-search">
                                ...
                                <input type="text" placeholder="Buscar Instructor" class="app-filter" id="global_filter">
                            </div>
    ...
    <div id="modal-change-status" class="modal md-modal">
        ...
        <div class="modal-footer">
            <form method="POST" action="{{route('admin.lesson.change.status')}}">
                @method('PUT')
                @csrf
                <input type="hidden" name="id" value="">
