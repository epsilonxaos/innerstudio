...
@endpush
    ...
    <div id="main">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m6 l6">
                            <h5 class="m-0 sidebar-title"><i class="fas fa-users"></i> Reservaciones (<span id="total-entries"></span>)</h5>
                        </div>
        ...
        <div class="row">
            <div class="col s12">
                <div class="container">
                        @if(Auth::user()->checkPermiso("cre_reservaciones"))
                    <!-- Add new contact popup -->
                    <div style="bottom: 54px; right: 19px;" class="fixed-action-btn direction-top">
                        <a class="btn-floating btn-large primary-text gradient-shadow modal-trigger" href="{{route('admin.reservations.create')}}">
    ...
    <div id="modal-cancel" class="modal md-modal">
...
@push('js')
    ...
    <script src="{{asset('admin/js/custom/reservations.js')}}"></script>
